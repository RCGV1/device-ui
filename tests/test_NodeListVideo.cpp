...
TEST_CASE("node list video CLI accepts the production compatibility option")
{
    const char *arguments[] = {
        "node_list_video", "--implementation",    "production", "--nodes", "25", "--seed", "42", "--output-frames", "9",
...
{
    const char *incomplete[] = {"node_list_video", "--implementation", "production", "--nodes", "25"};
    NodeListVideoOptions options{};
    std::string error;
