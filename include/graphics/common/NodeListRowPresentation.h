...
inline void formatTelemetryLines(const meshtastic_EnvironmentMetrics &metrics, bool metricUnits, char *telemetry1Text,
                                 size_t telemetry1Size, char *telemetry2Text, size_t telemetry2Size)
{
    telemetry2Text[0] = '\0';
    if (metricUnits) {
